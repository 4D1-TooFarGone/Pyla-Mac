...
class WindowController:
    ...
    def release_all_touches(self):
        try:
            self.touch_up(self.joystick_x or 0, self.joystick_y or 0, pointer_id=self.PID_JOYSTICK)
        except Exception:
            pass
        try:
            self.touch_up(960 * (self.width_ratio or 1), 540 * (self.height_ratio or 1), pointer_id=self.PID_ATTACK)
        except Exception:
            pass
        self.are_we_moving = False
        self.last_joystick_pos = (None, None)
